...
EXTERN int	p_bw	INIT(= TRUE);		/* backspace wraps in command mode */
...
EXTERN long p_uc	INIT(= 1000);		/* update count for swap file */
#endif
EXTERN long p_ut	INIT(= 10000);		/* update time for swap file */
