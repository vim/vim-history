...
void copy_global_options __ARGS((void));
void buf_copy_options __ARGS((buf_t *buf, int flags));
void set_context_in_set_cmd __ARGS((char_u *arg, int opt_flags));
int ExpandSettings __ARGS((regprog_t *prog, int *num_file, char_u ***file));
