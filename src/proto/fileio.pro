...
void check_timestamps __ARGS((void));
void buf_check_timestamp __ARGS((BUF *buf));
...
int apply_autocmds __ARGS((EVENT_T event, char_u *fname, char_u *fname_io, int force));
char_u *set_context_in_autocmd __ARGS((char_u *arg, int doautocmd));
char_u *get_event_name __ARGS((int idx));
char_u *file_pat_to_reg_pat __ARGS((char_u *pat, char_u *pat_end, char *allow_dirs));
