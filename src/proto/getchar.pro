...
int map_to_exists __ARGS((char_u *name, char_u *modechars));
char_u *set_context_in_map_cmd __ARGS((char_u *cmd, char_u *arg, int forceit, int isabbrev, int isunmap, cmdidx_t cmdidx));
