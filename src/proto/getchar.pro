...
extern void AppendToRedobuffLit __ARGS((char_u *s));
...
extern int map_to_exists __ARGS((char_u *str, char_u *modechars));
extern int map_to_exists_mode __ARGS((char_u *rhs, int mode));
...
extern char_u *check_map __ARGS((char_u *keys, int mode, int exact));
