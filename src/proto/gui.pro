...
char_u *gui_menu_name_skip __ARGS((char_u *name));
...
char_u *gui_menu_text __ARGS((char_u *text, int *mnemonic, char_u **actext));
int gui_menubar_menu __ARGS((char_u *name));
int gui_popup_menu __ARGS((char_u *name));
int gui_toolbar_menu __ARGS((char_u *name));
