/* quickfix.c */
extern int qf_init __ARGS((char_u *efile, char_u *errorformat, int newlist));
extern void qf_jump __ARGS((int dir, int errornr, int forceit));
extern void qf_list __ARGS((exarg_T *eap));
extern void qf_age __ARGS((exarg_T *eap));
extern void qf_mark_adjust __ARGS((linenr_T line1, linenr_T line2, long amount, long amount_after));
extern void ex_cwindow __ARGS((exarg_T *eap));
extern void ex_cclose __ARGS((exarg_T *eap));
extern void ex_copen __ARGS((exarg_T *eap));
extern linenr_T qf_current_entry __ARGS((void));
