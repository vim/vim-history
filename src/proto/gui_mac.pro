...
short gui_mch_get_mac_menu_item_index __PARMS((vimmenu_T *menu, vimmenu_T *parent));
...
void gui_mch_enable_scrollbar __PARMS((scrollbar_T *sb, int flag));
void gui_mch_set_scrollbar_thumb __PARMS((scrollbar_T *sb, long val, long size, long max));
void gui_mch_set_scrollbar_pos __PARMS((scrollbar_T *sb, int x, int y, int w, int h));
void gui_mch_create_scrollbar __PARMS((scrollbar_T *sb, int orient));
void gui_mch_destroy_scrollbar __PARMS((scrollbar_T *sb));
...
guicolor_T gui_mch_get_color __PARMS((char_u *name));
void gui_mch_set_fg_color __PARMS((guicolor_T color));
void gui_mch_set_bg_color __PARMS((guicolor_T color));
...
void gui_mch_draw_hollow_cursor __PARMS((guicolor_T color));
void gui_mch_draw_part_cursor __PARMS((int w, int h, guicolor_T color));
...
/*void gui_mch_add_menu __PARMS((vimmenu_T *menu, vimmenu_T *parent, int idx));*/
void gui_mch_add_menu __ARGS((vimmenu_T *menu, int pos));
/*void gui_mch_add_menu_item __PARMS((vimmenu_T *menu, vimmenu_T *parent, int idx));*/
void gui_mch_add_menu_item __ARGS((vimmenu_T *menu, int idx));
void gui_mch_show_popupmenu __PARMS((vimmenu_T *menu));
void gui_mch_destroy_menu __PARMS((vimmenu_T *menu));
void gui_mch_menu_grey __PARMS((vimmenu_T *menu, int grey));
void gui_mch_menu_hidden __PARMS((vimmenu_T *menu, int hidden));
...
void gui_win_new_height __PARMS((win_T *wp));
void gui_win_comp_pos __PARMS((void));
void gui_win_free __PARMS((win_T *wp));
