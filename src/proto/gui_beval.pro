/* gui_beval.c */
BalloonEval *gui_mch_create_beval_area __ARGS((Widget target, char_u *msg, void (*msgCB)(BalloonEval *, int), XtPointer clientData));
...
void gui_mch_post_balloon __ARGS((BalloonEval *beval, char_u *msg));
/* vim: set ft=c : */
