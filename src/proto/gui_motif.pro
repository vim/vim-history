...
void gui_mch_add_menu __ARGS((GuiMenu *menu, GuiMenu *parent, int idx));
void gui_mch_toggle_tearoffs __ARGS((int enable));
void gui_mch_add_menu_item __ARGS((GuiMenu *menu, GuiMenu *parent, int idx));
...
void gui_mch_show_popupmenu __ARGS((GuiMenu *menu));
