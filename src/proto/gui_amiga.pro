...
extern int gui_mch_set_blinking __ARGS((long wait, long on, long off));
extern void gui_mch_prepare __ARGS((int *argc, char **argv));
extern void atexitDoThis __ARGS((void));
...
extern void gui_mch_exit __ARGS((int returnCode));
...
extern int gui_mch_adjust_charsize __ARGS((void));
...
extern void gui_mch_set_colors __ARGS((guicolor_T fg, guicolor_T bg));
...
extern int gui_mch_get_mouse_x __ARGS((void));
extern int gui_mch_get_mouse_y __ARGS((void));
