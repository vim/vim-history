...
extern int latin_ptr2len_check __ARGS((char_u *p));
...
extern int utfc_ptr2char __ARGS((char_u *p, int *p1, int *p2));
extern int utfc_ptr2char_len __ARGS((char_u *p, int *p1, int *p2, int maxlen));
extern int utfc_char2bytes __ARGS((int off, char_u *buf));
extern int utf_ptr2len_check __ARGS((char_u *p));
extern int utf_byte2len __ARGS((int b));
extern int utf_ptr2len_check_len __ARGS((char_u *p, int size));
extern int utfc_ptr2len_check __ARGS((char_u *p));
extern int utfc_ptr2len_check_len __ARGS((char_u *p, int size));
...
extern int mb_strnicmp __ARGS((char_u *s1, char_u *s2, int n));
