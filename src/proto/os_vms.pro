...
long mch_avail_mem __ARGS((int special));
...
int is_fastterm __ARGS((char_u *name));
...
void vul_desc __ARGS((int *des, char *str));
...
int WaitForChar __ARGS((long msec));
