...
extern void print_line_no_prefix __ARGS((linenr_T lnum, int use_number));
extern void print_line __ARGS((linenr_T lnum, int use_number));
...
extern void prepare_tagpreview __ARGS((void));
