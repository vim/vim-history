/* gui_photon.c */
void gui_ph_draw_start __ARGS((void));
void gui_ph_draw_end __ARGS((void));
...
int gui_mch_dialog __ARGS((int type, char_u *title, char_u *message, char_u *buttons, int default_button));
...
void gui_ph_position_menu __ARGS((int *widget, int priority));
