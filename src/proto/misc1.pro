...
extern int get_number __ARGS((int colon));
...
extern void expand_env_esc __ARGS((char_u *src, char_u *dst, int dstlen, int esc));
...
extern char_u *get_cmd_output __ARGS((char_u *cmd, int flags));
