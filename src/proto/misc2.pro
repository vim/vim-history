...
void set_fileformat __ARGS((int t, int local));
...
int vim_findfile_init __ARGS((char_u *path, char_u *filename, char_u *stopdirs, int level, int free_visited));
char_u *vim_findfile_stopdir __ARGS((char_u *buf));
char_u *vim_findfile __ARGS((void));
void vim_findfile_free_visited __ARGS((void));
