...
int buf_addsign __ARGS((buf_t *buf, int id, int lineno, int type));
int buf_change_sign_type __ARGS((buf_t *buf, int markId, int newType));
int_u buf_getsigntype __ARGS((buf_t *buf, int_u lnum));
int buf_delsign __ARGS((buf_t *buf, int id));
int buf_findsign __ARGS((buf_t *buf, int id));
int buf_findsign_id __ARGS((buf_t *buf, int lnum));
