...
char_u *getaltfname __ARGS((void));
int buflist_add __ARGS((char_u *fname));
void buflist_altlnum __ARGS((void));
int otherfile __ARGS((char_u *fname));
