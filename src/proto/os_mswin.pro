...
int ole_SendKeys __ARGS((const char_u *sKeys));
char_u *ole_Eval __ARGS((const char_u *sExpr));
unsigned ole_GetHwnd __ARGS((void));
void ole_SetForeground __ARGS((void));
int ole_client_init __ARGS((void));
void ole_client_close __ARGS((void));
/* vim: set ft=c : */
