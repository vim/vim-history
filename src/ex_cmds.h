...
EX(CMD_args,		"args",		ex_args,
			BANG|NAMEDFS|EDITCMD|ARGOPT|TRLBAR),
...
EX(CMD_elseif,		"elseif",	ex_else,
			EXTRA|NOTRLCOM),
EX(CMD_exemenu,		"emenu",	execute_menu,
...
EX(CMD_next,		"next",		ex_next,
			RANGE|NOTADR|BANG|NAMEDFS|EDITCMD|ARGOPT|TRLBAR),
...
EX(CMD_normal,		"normal",	ex_normal,
			RANGE|BANG|EXTRA|NEEDARG|NOTRLCOM|USECTRLV),
...
EX(CMD_read,		"read",		ex_read,
			BANG|RANGE|NAMEDF|TRLBAR|ZEROR),
