...
EX(CMD_abclear,		"abclear",	ex_abclear,
			EXTRA|TRLBAR|CMDWIN),
EX(CMD_aboveleft,	"aboveleft",	ex_aboveleft,
...
EX(CMD_belowright,	"belowright",	ex_belowright,
			NEEDARG|EXTRA|NOTRLCOM),
...
EX(CMD_hardcopy,	"hardcopy",	ex_hardcopy,
			RANGE|COUNT|TRLBAR|DFLALL|BANG),
...
EX(CMD_left,		"left",		ex_align,
			TRLBAR|RANGE|WHOLEFOLD|EXTRA|CMDWIN|MODIFY),
EX(CMD_leftabove,	"leftabove",	ex_aboveleft,
			NEEDARG|EXTRA|NOTRLCOM),
...
EX(CMD_right,		"right",	ex_align,
			TRLBAR|RANGE|WHOLEFOLD|EXTRA|CMDWIN|MODIFY),
EX(CMD_rightbelow,	"rightbelow",	ex_belowright,
			NEEDARG|EXTRA|NOTRLCOM),
...
EX(CMD_setlocal,	"setlocal",	ex_set,
			TRLBAR|EXTRA|CMDWIN),
EX(CMD_serverlist,	"serverlist",	ex_serverlist,
			TRLBAR|EDITCMD|CMDWIN),
EX(CMD_serversend,	"serversend",	ex_serversend,
			TRLBAR|NEEDARG|EDITCMD|EXTRA|CMDWIN),
