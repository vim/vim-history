...
EX(CMD_dlist,		"dlist",	ex_findpat,
			BANG|RANGE|DFLALL|EXTRA|CMDWIN),
...
EX(CMD_put,		"put",		ex_put,
			RANGE|BANG|REGSTR|TRLBAR|ZEROR|CMDWIN),
...
EX(CMD_read,		"read",		ex_read,
			BANG|RANGE|FILE1|ARGOPT|TRLBAR|ZEROR|CMDWIN),
...
EX(CMD_retab,		"retab",	ex_retab,
			TRLBAR|RANGE|DFLALL|BANG|WORD1|CMDWIN),
...
EX(CMD_sign,		"sign",		ex_sign,
			RANGE|EXTRA|NOTADR|NOSPC|CMDWIN),
...
EX(CMD_sleep,		"sleep",	ex_sleep,
			RANGE|COUNT|NOTADR|EXTRA|TRLBAR|CMDWIN),
