...
#endif
static int		cstrncmp __ARGS((char *s1, char *s2, int n));
...
/*	extern char    *malloc();*/
	...
	if (*exp == '\0') {
		if (reg_prev_re) {
			...
			FAIL("No previous regular expression");
		}
	}
#endif
