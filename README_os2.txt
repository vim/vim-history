README_os2.txt for version 5.7a of Vim: Vi IMproved.
...
NOTE: You will need two archives:
  vim57rt.zip	contains the runtime files (same as for the PC version)
  vim57os2.zip	contains the OS/2 executables
