===============================================================================
=    Д о б р о   п о ж а л о в а т ь   в   у ч е б н и к   VIM  -  Версия 1.4 =
===============================================================================
...
---> Заметьте, что если Вы выйдете из Vim и затем запустите его снова с
  ...
  5. Теперь удалите этот файл, набрав :!delete TEST
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  1.  :!команда  исполняет внешнюю команду.
	  ...
	  :!delete FILENAME --- удаляет файл FILENAME.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  соответствующий аргумент команде ":help". Попробуйте следующее:
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  Взгляните на http://www.iccf.nl/click5.html
  ...
  Перевод Андрей Киселев, 2002. Замечания, предложения по переводу:
  a_kissel@eudoramail.com
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
