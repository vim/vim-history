...
an 50.10.150 &Syntax.AB.Altera\ AHDL :cal SetSyn("ahdl")<CR>
an 50.10.160 &Syntax.AB.Amiga\ DOS :cal SetSyn("amiga")<CR>
an 50.10.170 &Syntax.AB.AMPL :cal SetSyn("ampl")<CR>
an 50.10.180 &Syntax.AB.Ant\ build\ file :cal SetSyn("ant")<CR>
an 50.10.190 &Syntax.AB.ANTLR :cal SetSyn("antlr")<CR>
an 50.10.200 &Syntax.AB.Apache\ config :cal SetSyn("apache")<CR>
an 50.10.210 &Syntax.AB.Apache-style\ config :cal SetSyn("apachestyle")<CR>
an 50.10.220 &Syntax.AB.Applix\ ELF :cal SetSyn("elf")<CR>
an 50.10.230 &Syntax.AB.Arc\ Macro\ Language :cal SetSyn("aml")<CR>
an 50.10.240 &Syntax.AB.ASP\ with\ VBScript :cal SetSyn("aspvbs")<CR>
an 50.10.250 &Syntax.AB.ASP\ with\ Perl :cal SetSyn("aspperl")<CR>
an 50.10.260 &Syntax.AB.Assembly.680x0 :cal SetSyn("asm68k")<CR>
an 50.10.270 &Syntax.AB.Assembly.GNU :cal SetSyn("asm")<CR>
an 50.10.280 &Syntax.AB.Assembly.GNU\ H-8300 :cal SetSyn("asmh8300")<CR>
an 50.10.290 &Syntax.AB.Assembly.Intel\ IA-64 :cal SetSyn("ia64")<CR>
an 50.10.300 &Syntax.AB.Assembly.Microsoft :cal SetSyn("masm")<CR>
an 50.10.310 &Syntax.AB.Assembly.Netwide :cal SetSyn("nasm")<CR>
an 50.10.320 &Syntax.AB.Assembly.PIC :cal SetSyn("pic")<CR>
an 50.10.330 &Syntax.AB.Assembly.Turbo :cal SetSyn("tasm")<CR>
an 50.10.340 &Syntax.AB.Assembly.Z-80 :cal SetSyn("z8a")<CR>
an 50.10.350 &Syntax.AB.ASN\.1 :cal SetSyn("asn")<CR>
an 50.10.360 &Syntax.AB.Atlas :cal SetSyn("atlas")<CR>
an 50.10.370 &Syntax.AB.Automake :cal SetSyn("automake")<CR>
an 50.10.380 &Syntax.AB.Avenue :cal SetSyn("ave")<CR>
an 50.10.390 &Syntax.AB.Awk :cal SetSyn("awk")<CR>
an 50.10.400 &Syntax.AB.AYacc :cal SetSyn("ayacc")<CR>
an 50.10.420 &Syntax.AB.B :cal SetSyn("b")<CR>
an 50.10.430 &Syntax.AB.Baan :cal SetSyn("baan")<CR>
an 50.10.440 &Syntax.AB.BASIC :cal SetSyn("basic")<CR>
an 50.10.450 &Syntax.AB.BC\ calculator :cal SetSyn("bc")<CR>
an 50.10.460 &Syntax.AB.BDF\ font :cal SetSyn("bdf")<CR>
an 50.10.470 &Syntax.AB.BibTeX :cal SetSyn("bib")<CR>
an 50.10.480 &Syntax.AB.BIND\ config :cal SetSyn("named")<CR>
an 50.10.490 &Syntax.AB.BIND\ zone :cal SetSyn("bindzone")<CR>
an 50.10.500 &Syntax.AB.Blank :cal SetSyn("blank")<CR>
...
an 50.20.130 &Syntax.CD.Crontab :cal SetSyn("crontab")<CR>
an 50.20.140 &Syntax.CD.Cyn++ :cal SetSyn("cynpp")<CR>
an 50.20.150 &Syntax.CD.Cynlib :cal SetSyn("cynlib")<CR>
an 50.20.160 &Syntax.CD.Cascading\ Style\ Sheets :cal SetSyn("css")<CR>
an 50.20.170 &Syntax.CD.Century\ Term :cal SetSyn("cterm")<CR>
an 50.20.180 &Syntax.CD.CHILL :cal SetSyn("ch")<CR>
an 50.20.190 &Syntax.CD.ChangeLog :cal SetSyn("changelog")<CR>
an 50.20.200 &Syntax.CD.Clean :cal SetSyn("clean")<CR>
an 50.20.210 &Syntax.CD.Clever :cal SetSyn("cl")<CR>
an 50.20.220 &Syntax.CD.Clipper :cal SetSyn("clipper")<CR>
an 50.20.230 &Syntax.CD.Cold\ Fusion :cal SetSyn("cf")<CR>
an 50.20.240 &Syntax.CD.Config\ file\ (CFG) :cal SetSyn("cfg")<CR>
an 50.20.250 &Syntax.CD.Configure\.in :cal SetSyn("config")<CR>
...
an 50.20.340 &Syntax.CD.Debian.Debian\ ChangeLog :cal SetSyn("debchangelog")<CR>
an 50.20.350 &Syntax.CD.Debian.Debian\ Control :cal SetSyn("debcontrol")<CR>
an 50.20.360 &Syntax.CD.Diff :cal SetSyn("diff")<CR>
an 50.20.370 &Syntax.CD.Digital\ Command\ Lang :cal SetSyn("dcl")<CR>
an 50.20.380 &Syntax.CD.DNS/BIND\ zone :cal SetSyn("dns")<CR>
an 50.20.390 &Syntax.CD.Dot :cal SetSyn("dot")<CR>
an 50.20.400 &Syntax.CD.Dracula :cal SetSyn("dracula")<CR>
an 50.20.410 &Syntax.CD.DSSSL :cal SetSyn("dsl")<CR>
an 50.20.420 &Syntax.CD.DTD :cal SetSyn("dtd")<CR>
an 50.20.430 &Syntax.CD.DTML\ (Zope) :cal SetSyn("dtml")<CR>
an 50.20.440 &Syntax.CD.Dylan.Dylan :cal SetSyn("dylan")<CR>
an 50.20.450 &Syntax.CD.Dylan.Dylan\ interface :cal SetSyn("dylanintr")<CR>
an 50.20.460 &Syntax.CD.Dylan.Dylan\ lid :cal SetSyn("dylanlid")<CR>
...
an 50.50.310 &Syntax.L-Ma.Maple\ V :cal SetSyn("maple")<CR>
...
an 50.60.170 &Syntax.Me-NO.MOO :cal SetSyn("moo")<CR>
an 50.60.180 &Syntax.Me-NO.MS-DOS/Windows.4DOS\ \.bat\ file :cal SetSyn("btm")<CR>
an 50.60.190 &Syntax.Me-NO.MS-DOS/Windows.\.bat\ file :cal SetSyn("dosbatch")<CR>
an 50.60.200 &Syntax.Me-NO.MS-DOS/Windows.\.ini\ file :cal SetSyn("dosini")<CR>
an 50.60.210 &Syntax.Me-NO.MS-DOS/Windows.Module\ Definition :cal SetSyn("def")<CR>
an 50.60.220 &Syntax.Me-NO.MS-DOS/Windows.Registry :cal SetSyn("registry")<CR>
an 50.60.230 &Syntax.Me-NO.MS-DOS/Windows.Resource\ file :cal SetSyn("rc")<CR>
an 50.60.240 &Syntax.Me-NO.Msql :cal SetSyn("msql")<CR>
an 50.60.250 &Syntax.Me-NO.MUSHcode :cal SetSyn("mush")<CR>
an 50.60.260 &Syntax.Me-NO.Muttrc :cal SetSyn("muttrc")<CR>
an 50.60.280 &Syntax.Me-NO.Nastran\ input/DMAP :cal SetSyn("nastran")<CR>
an 50.60.290 &Syntax.Me-NO.Natural :cal SetSyn("natural")<CR>
an 50.60.300 &Syntax.Me-NO.Novell\ NCF\ batch :cal SetSyn("ncf")<CR>
an 50.60.310 &Syntax.Me-NO.Not\ Quite\ C\ (LEGO) :cal SetSyn("nqc")<CR>
an 50.60.320 &Syntax.Me-NO.Nroff :cal SetSyn("nroff")<CR>
an 50.60.330 &Syntax.Me-NO.NSIS\ script :cal SetSyn("nsis")<CR>
an 50.60.350 &Syntax.Me-NO.Objective\ C :cal SetSyn("objc")<CR>
an 50.60.360 &Syntax.Me-NO.OCAML :cal SetSyn("ocaml")<CR>
an 50.60.370 &Syntax.Me-NO.Omnimark :cal SetSyn("omnimark")<CR>
an 50.60.380 &Syntax.Me-NO.OpenROAD :cal SetSyn("openroad")<CR>
an 50.60.390 &Syntax.Me-NO.Open\ Psion\ Lang :cal SetSyn("opl")<CR>
an 50.60.400 &Syntax.Me-NO.Oracle\ config :cal SetSyn("ora")<CR>
...
an 50.70.280 &Syntax.PQ.Povray\ Screen\ descr :cal SetSyn("pov")<CR>
...
an 50.80.350 &Syntax.R-Sg.SGML.SGML\ catalog :cal SetSyn("catalog")<CR>
an 50.80.360 &Syntax.R-Sg.SGML.SGML\ DTD :cal SetSyn("sgml")<CR>
an 50.80.370 &Syntax.R-Sg.SGML.SGML\ Declaration :cal SetSyn("sgmldecl")<CR>
an 50.80.380 &Syntax.R-Sg.SGML.SGML-linuxdoc :cal SetSyn("sgmllnx")<CR>
an 50.90.100 &Syntax.Sh-S.Shell\ script\ (sh,\ ksh) :cal SetSyn("sh")<CR>
...
an 50.90.160 &Syntax.Sh-S.SKILL.SKILL :cal SetSyn("skill")<CR>
an 50.90.170 &Syntax.Sh-S.SKILL.SKILL\ for\ Diva :cal SetSyn("diva")<CR>
an 50.90.180 &Syntax.Sh-S.SLRN.Slrn\ rc :cal SetSyn("slrnrc")<CR>
an 50.90.190 &Syntax.Sh-S.SLRN.Slrn\ score :cal SetSyn("slrnsc")<CR>
an 50.90.200 &Syntax.Sh-S.SmallTalk :cal SetSyn("st")<CR>
an 50.90.210 &Syntax.Sh-S.SMIL :cal SetSyn("smil")<CR>
an 50.90.220 &Syntax.Sh-S.SMITH :cal SetSyn("smith")<CR>
an 50.90.230 &Syntax.Sh-S.SNMP\ MIB :cal SetSyn("mib")<CR>
an 50.90.240 &Syntax.Sh-S.SNNS.SNNS\ network :cal SetSyn("snnsnet")<CR>
an 50.90.250 &Syntax.Sh-S.SNNS.SNNS\ pattern :cal SetSyn("snnspat")<CR>
an 50.90.260 &Syntax.Sh-S.SNNS.SNNS\ result :cal SetSyn("snnsres")<CR>
an 50.90.270 &Syntax.Sh-S.Snobol4 :cal SetSyn("snobol4")<CR>
an 50.90.280 &Syntax.Sh-S.Snort\ Configuration :cal SetSyn("hog")<CR>
an 50.90.290 &Syntax.Sh-S.SPEC\ (Linux\ RPM) :cal SetSyn("spec")<CR>
an 50.90.300 &Syntax.Sh-S.Specman :cal SetSyn("specman")<CR>
an 50.90.310 &Syntax.Sh-S.Spice :cal SetSyn("spice")<CR>
an 50.90.320 &Syntax.Sh-S.Speedup :cal SetSyn("spup")<CR>
an 50.90.330 &Syntax.Sh-S.Splint :cal SetSyn("splint")<CR>
an 50.90.340 &Syntax.Sh-S.Squid\ config :cal SetSyn("squid")<CR>
an 50.90.350 &Syntax.Sh-S.SQL.SQL :cal SetSyn("sql")<CR>
an 50.90.360 &Syntax.Sh-S.SQL.SQL\ Forms :cal SetSyn("sqlforms")<CR>
an 50.90.370 &Syntax.Sh-S.SQL.SQLJ :cal SetSyn("sqlj")<CR>
an 50.90.380 &Syntax.Sh-S.SQR :cal SetSyn("sqr")<CR>
an 50.90.390 &Syntax.Sh-S.Standard\ ML :cal SetSyn("sml")<CR>
an 50.90.400 &Syntax.Sh-S.Stored\ Procedures :cal SetSyn("stp")<CR>
an 50.90.410 &Syntax.Sh-S.Strace :cal SetSyn("strace")<CR>
...
an 50.110.310 &Syntax.WXYZ.Xslt :cal SetSyn("xslt")<CR>
an 50.110.320 &Syntax.WXYZ.XXD\ hex\ dump :cal SetSyn("xxd")<CR>
an 50.110.330 &Syntax.WXYZ.XFree86\ Config :cal SetSyn("xf86conf")<CR>
an 50.110.350 &Syntax.WXYZ.Yacc :cal SetSyn("yacc")<CR>
an 50.110.370 &Syntax.WXYZ.Zsh\ shell\ script :cal SetSyn("zsh")<CR>
