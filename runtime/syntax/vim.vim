...
" Function Names
syn keyword vimFuncName contained	append	delete	has	line2byte	strtrans
syn keyword vimFuncName contained	argc	did_filetype	histadd	localtime	substitute
syn keyword vimFuncName contained	argv	escape	histdel	maparg	synID
syn keyword vimFuncName contained	browse	exists	histget	mapcheck	synIDattr
syn keyword vimFuncName contained	bufexists	expand	histnr	match	synIDtrans
syn keyword vimFuncName contained	bufloaded	filereadable	hlID	matchend	system
syn keyword vimFuncName contained	bufname	fnamemodify	hlexists	matchstr	tempname
syn keyword vimFuncName contained	bufnr	getcwd	hostname	nr2char	virtcol
...
syn keyword vimFuncName contained	confirm	glob
...
" Filetypes
" =========
syn keyword vimFiletype	filetype	skipwhite	nextgroup=vimFTOnOff,vimFTError
syn keyword vimFTOnOff	on	off
...
if !exists("did_vim_syntax_inits")
  ...
  hi link vimFiletype	vimCommand
