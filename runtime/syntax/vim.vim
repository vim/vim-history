...
" Operators: {{{2
" =========
syn cluster vimOperGroup	contains=vimOper,vimOperParen,vimNumber,vimString,vimOperOk,vimContinue
syn match  vimOper	"\(==\|!=\|>=\|<=\|=\~\|!\~\|>\|<\|=\)[?#]\{0,2}"	skipwhite nextgroup=vimString,vimSpecFile
syn match  vimOper	"||\|&&\|[-+.]"	skipwhite nextgroup=vimString,vimSpecFile
syn region vimOperParen	matchgroup=vimOper start="(" end=")" contains=@vimOperGroup
syn match  vimOperOk	"\<[aiAIrR]\ze[()]" contained
if !exists("g:vimsyntax_noerror")
...
"   syn cluster vimMapRhsGroup add=vimMapRhsString
syn cluster vimMapRhsGroup	contains=vimMark,vimNotation
...
syn match   vimMapRhs    contained	".*$"	contains=@vimMapRhsGroup
...
syn region  vimMapRhsString	start=+[^:a-zA-Z>!\\]\zs"+ skip=+\\\\\|\\"+ end=+"+	contained contains=@vimStringGroup
syn region  vimMapRhsString	start=+[^:a-zA-Z>!\\]\zs'+ end=+'+		contained contains=@vimStringGroup
syn case ignore
...
" Normal {{{2
" ======
syn keyword vimNormal norm[al] skipwhite nextgroup=vimNormalBang,vimNormalCmd
syn match   vimNormalCmd  contained	".*$"
syn match   vimNormalBang contained	"!"	skipwhite nextgroup=vimNormalCmd
...
hi def link vimMapLhs	vimSpecial
hi def link vimMapRhsString	vimString
hi def link vimMarkNumber	vimNumber
hi def link vimMenuMod	vimMapMod
hi def link vimMenuNameMore	vimMenuName
hi def link vimMtchComment	vimComment
hi def link vimNormal	vimCommand
hi def link vimNormalBang	vimNormal
