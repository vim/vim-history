...
"sy	region	EssFold	start="/\*\([^*]*\*\(/\)\@!\)*[^*]*$" end="\*/" transparent fold
...
"hex number
syn match	cscNumber	contained "0x\x\+\(u\=l\{0,2}\|ll\=u\)\>"
...
sy	region	cscComment	start="/\*" end="\*/" contains=@cscCommentGroup,cscSpaceE
...
sy	keyword	cscStatement	AGG ARRAY VAR
sy	keyword	cscStatement	CCONV CLEARDATA DATACOPY
...
hi	def cscVarName term=bold ctermfg=9 gui=bold guifg=blue
