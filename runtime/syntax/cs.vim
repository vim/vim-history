" Vim syntax file
" Language:	C#
" Maintainer:	Israel Raj Thomas <israelt@optushome.com.au>
" Based heavily on the c.vim by Bram Moolenaar <Bram@vim.org> and the
" cpp.vim by Ken Shan <ccshan@post.harvard.edu>
...
" A bunch of useful C Sharp keywords


syn keyword csStatement		goto break return continue asm class new delete this friend using
syn keyword csAccess		public protected private
syn keyword csConditional	if else switch
syn keyword csLabel		case default
syn keyword csRepeat		while for do
syn keyword csType		inline virtual explicit export bool wchar_t
syn keyword csExceptions	throw try catch
syn keyword csOperator		operator typeid
syn match  csCast		"\<\(const\|static\|dynamic\|reinterpret\)_cast\s*<"me=e-1
syn match  csCast		"\<\(const\|static\|dynamic\|reinterpret\)_cast\s*$"
syn keyword csStorageClass	mutable
syn keyword csStructure	class typename template namespace
syn keyword csNumber	NPOS
syn keyword csBoolean	true false
syn keyword	csTodo		contained TODO FIXME XXX
