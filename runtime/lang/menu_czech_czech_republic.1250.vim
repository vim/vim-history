...
menutrans &Next\ Error<Tab>:cn		&Další\ chyba<Tab>:cn
...
menutrans &Max\ Height<Tab>^W_		Maximální\ výška<Tab>^W_
menutrans M&in\ Height<Tab>^W1_		Minimální\ výška<Tab>^W1_
menutrans Max\ &Width<Tab>^W\|		Maximální\ šíøka<Tab>^W\|
menutrans Min\ Widt&h<Tab>^W1\|		Minimální\ šíøka<Tab>^W1\|
