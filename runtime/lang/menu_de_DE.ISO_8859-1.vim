...
menutrans Co&pying		Co&pyright	" Urheberrecht ?
...
menutrans Sp&lit-Open\.\.\.<Tab>:sp	In\ neuem\ &Fenster\ Öffnen\.\.\.<Tab>:sp
...
menutrans Repea&t<Tab>\.		&Wiederholen<Tab>\.
...
menutrans Find\ and\ R&eplace\.\.\.	Suchen\ und\ &Ersetzen\.\.\.
...
menutrans P&revious<Tab>^WW		&Vorheriges<Tab>^WW
...
if has("win32") || has("gui_gtk")
  ...
  fun Do_toolbar_tmenu()
    ...
    tmenu ToolBar.LoadSesn	Session Laden
    tmenu ToolBar.SaveSesn	Session Speichern
    tmenu ToolBar.RunScript	Vim Script Ausführen
    ...
    tmenu ToolBar.FindHelp	Hilfe Finden...
  endfun
endif
...
menutrans &on\ (this\ file)	A&n\ (diese\ Datei)
