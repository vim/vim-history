...
menutrans Toggle\ Pattern\ &Highlight<Tab>:set\ hls!	Prze³¹cz\ podkreœlanie\ &wzorców<Tab>:set\ hls!

menutrans Toggle\ &Ignore-case<Tab>:set\ ic!		Prze³¹cz\ &ignorowanie\ wielkoœci<Tab>:set\ ic!
